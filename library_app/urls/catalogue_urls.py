...
from ..views import catalogue_add, catalogue_list, catalogue_update, catalogue_delete, catalogue_view, get_books_by_centre
...
catalogue_urlpatterns = [
    ...
    path('catalogue/view/<int:pk>/', catalogue_view, name='catalogue_view'),

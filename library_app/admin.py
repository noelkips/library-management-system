...
class BookAdmin(admin.ModelAdmin):
    list_display = ('title', 'author', 'book_code', 'centre', 'total_copies', 'is_available', 'is_active')
    list_filter = ('centre', 'is_active', 'is_available')
    ...
    fieldsets = (
        ...
        ('Inventory', {
            'fields': ('total_copies', 'is_available')
        }),
        ('Location', {
